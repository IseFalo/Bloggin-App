...
urlpatterns=[
    ...
    path('profile-product-list/<str:username>', views.ProfileProductListView.as_view(), name="profile-product-list"),
    path('profile-bio/<str:username>', views.profile_bio, name="profile-bio"),
